...
test_data = dset.CIFAR100(f'{args.data_dir}/cifarpy', train=False, transform=test_transform)
num_classes = 100
...
if args.score == 'Odin':
    ...
    train_data = dset.CIFAR100(f'{args.data_dir}/cifarpy', train=True, transform=test_transform)
...
#
# /////////////// Textures ///////////////
ood_data = dset.ImageFolder(root=f"{args.data_dir}/dtd/images",
...
ood_data = svhn.SVHN(root=f'{args.data_dir}/svhn/', split="test",
...
# /////////////// Places365 ///////////////
ood_data = dset.ImageFolder(root=f"{args.data_dir}/places365/",
                            transform=trn.Compose([trn.Resize(32), trn.CenterCrop(32),
                                                   trn.ToTensor(), trn.Normalize(mean, std)]))
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.test_bs, shuffle=True,
                                         num_workers=2, pin_memory=True)
...
# /////////////// LSUN-C ///////////////
ood_data = dset.ImageFolder(root=f"{args.data_dir}/LSUN_C",
...
# # /////////////// LSUN-R ///////////////
# ood_data = dset.ImageFolder(root=f"{args.data_dir}/LSUN_resize",
#                             transform=trn.Compose([trn.ToTensor(), trn.Normalize(mean, std)]))
# ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.test_bs, shuffle=True,
#                                          num_workers=1, pin_memory=True)
...
# /////////////// iSUN ///////////////
ood_data = dset.ImageFolder(root=f"{args.data_dir}/iSUN",
                            transform=trn.Compose([trn.ToTensor(), trn.Normalize(mean, std)]))
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.test_bs, shuffle=True,
                                         num_workers=1, pin_memory=True)
print('\n\niSUN Detection')
