...
test_data = \
    ...
    os.path.join(f'{args.data_dir}/imagenet-100', 'val'),
    trn.Compose([
        trn.Resize(256),
        trn.CenterCrop(224),
        trn.ToTensor(),
...
ood_loader = torch.utils.data.DataLoader(
                torchvision.datasets.ImageFolder(f"{args.data_dir}/iNaturalist/",
...
# /////////////// Places365 ///////////////
ood_data = dset.ImageFolder(root=f"{args.data_dir}/Places/",
                            transform=trn.Compose([
    trn.Resize(256),
    trn.CenterCrop(224),
    trn.ToTensor(),
...
# /////////////// sun ///////////////
ood_data = dset.ImageFolder(root=f"{args.data_dir}/SUN/",
                            transform=trn.Compose([
    trn.Resize(256),
    trn.CenterCrop(224),
    trn.ToTensor(),
